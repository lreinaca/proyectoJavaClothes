...
public class ReporteVentas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Pantalon Hombre", "Blanco", "S", "8"},
                {"Blusa Manga Larga", "Roja", "XXL", "2"},
                {"Tennis Nike", "Verde", "38", "10"},
                {"Camiseta Mujer", "Blanco", "M", "20"}
            },
            new String [] {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("GRAFICOS DE VENTAS"));

        jLabel3.setText("UTILIZAMOS INTELIGENCIA ARTIFICIAL : ");

        jButton2.setText("VER GRÁFICOS");
        ...
        jTextArea1.setText("Se genera el gráfico de las ventas ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(null, "APARECEN LOS GRAFICOS QUE GENERA LA IA");
