 ...
 * @author Rossi
 */
public final class HistorialPedidosClientes extends javax.swing.JPanel {
    ...
    // METODO PARA LLENAR LA TABLA DE PEDIDOS CLIENTE
    private void listarPedidosCliente() {
        ...
        try {
            List<DetallePedidoClienteDTO> detallesPedido = detallePedidoApi.getDetallesPedidoByUsuarioID(usuarioLogueado.getUsua_id());

            for (DetallePedidoClienteDTO detalle : detallesPedido) {
                double total = detalle.getCantidad() * detalle.getPrecioUnitario();

                model.addRow(new Object[]{
                    detalle.getProductoNombre(),
                    formatoPesos.format(detalle.getPrecioUnitario()),
                    formatoPesos.format(total),});
            }
            tbPedidos.setModel(model);

            // Ajustar el ancho de las columnas
            tbPedidos.getColumnModel().getColumn(0).setPreferredWidth(150); // Nombre_Producto
            tbPedidos.getColumnModel().getColumn(1).setPreferredWidth(75); // Precio
            tbPedidos.getColumnModel().getColumn(2).setPreferredWidth(75);  // Total
    ...
    private void initComponents() {
        ...
        tbPedidos.setBackground(new java.awt.Color(204, 204, 255));
        tbPedidos.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jLabel2.setText("Lista de productos Agregados a Favoritos:");
